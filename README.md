...
- Weather: dedicated tab for city or ZIP, Use my location, hourly + 7-day, and a map. Toggle the module in Options. ZIP 10001 is New York even on a Philippines desk
...
Needs Microsoft JDK 17, Android SDK (`%LOCALAPPDATA%\Android\Sdk`), NDK, Rust `aarch64-linux-android`. Output: `deploy/android/atrium-v1.2.11-arm64-release.apk`.
